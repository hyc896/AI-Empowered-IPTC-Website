...
from app.routers import upload, book_graph

# 创建 FastAPI 应用（禁用默认文档）
app = FastAPI(
    title=settings.APP_NAME + " (书籍知识图谱)",
    version=settings.APP_VERSION,
    description="书籍上传与知识图谱可视化",
...
app.include_router(book_graph.router, prefix=settings.API_PREFIX)
