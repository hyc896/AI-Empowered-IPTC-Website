-- Ars Technica采集器注册脚本
-- 执行命令（Linux）：
-- mysql -h localhost -P 3306 -u root -p123456 --default-character-set=utf8mb4 message_platform < backend/sources/ars_technica/register.sql

USE message_platform;

-- 1. 创建消息表
CREATE TABLE IF NOT EXISTS mp_ars_technica_messages (
...
INSERT INTO mp_message_sources (
    ...
    'ars_technica',
    'news',
    'Ars Technica（Ars Technica专注科技深度分析和技术评测，读者群体以专业人士为主）',
    JSON_OBJECT(
        'mysql_table', 'mp_ars_technica_messages',
        'chroma_collection', 'ars_technica_tech',
        'region', '美国',
        'language', 'en',
        'rss_url', 'https://feeds.arstechnica.com/arstechnica/index',
        'collector_module', 'backend.sources.ars_technica.collector',
...
-- 4. 检查表是否创建成功
SHOW CREATE TABLE mp_ars_technica_messages\G
