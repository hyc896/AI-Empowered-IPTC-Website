...
-- 1. 创建消息表
CREATE TABLE IF NOT EXISTS mp_der_spiegel_messages (
    ...
    language VARCHAR(10) DEFAULT 'de' COMMENT '语言',
...
WHERE name = 'Der Spiegel Netzwelt';

-- 4. 检查表是否创建成功
SHOW CREATE TABLE mp_der_spiegel_messages\G
